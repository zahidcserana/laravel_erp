...
<div style="margin:0 auto; width:100%; height:auto; overflow:hidden; text-align:center;">
	...
	<h3 class="style1" style="font-size:13px; font-weight:bold;">Head Office : 19-B/2-C & 2-D (5th Floor), Ring Road, Shyamoli, Dhaka-1207, Bangladesh. </h3>
	<h3 class="style1" style="font-size:13px; font-weight:bold;">Corporate Office : 8813 NW 23 Street, Miami, FL 33172, USA. </h3>
	<h3 class="style1" style="font-size:13px; font-weight:bold;">Phone : 88-02-55020230 | Cell : 88-01618-776609</h3>
	...
	<div style="text-align:center;"> <img width="120" src="{{asset('images/logo.gif')}}" /> </div>
</div>
@endsection
